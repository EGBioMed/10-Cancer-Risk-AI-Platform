...
**範圍**：僅限免費信（流程 B，`delivery_mode: public`）。

**不在範圍內**：

- 流程 A 的機構信 —— 機構為 B2B 關係，直接對其受檢者推銷未經該機構同意
- 流程 C 的交付信 —— 讀者剛購買完整報告，不在此次範圍
- 付費 PDF 報告內容
...
| 項目 | 需要誰決定 |
|---|---|
| 是否依 `country` 限制顯示對象。產品為美國 LDT、USD 計價、需醫師授權、寄送採集套組；免費線讀者主要在台灣與越南 | 業務 |
