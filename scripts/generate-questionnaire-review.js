...
const conditionByQuestion = {
  ...
  mastalgia: "僅性別選擇「女性」時顯示。本題自 v19.9 起併入「乳房症狀」題組，以勾選項呈現，不再單獨出現一頁；勾選＝是、未勾選＝否、整組選「不確定」時記為不確定。",
  constipation: "併入「腸道與下腹部症狀」題組，以勾選項呈現，不單獨出現一頁；勾選＝是、未勾選＝否、整組選「不確定」時記為不確定。",
