...
const LANGS = {
  zh: {
    ...
    cta: `<div style="border:2px solid #0f766e;border-radius:16px;background:#f9fcfb;padding:26px 24px;margin-bottom:26px;">
          ...
          <div style="margin:0 0 16px;">
            ...
            <span style="display:inline-block;margin-left:10px;font-size:15px;font-weight:700;color:#0f766e;line-height:2.1;">超過 60 頁的完整報告</span>
          </div>
          <p style="margin:0 0 20px;font-size:15px;line-height:1.9;color:#40514f;">只需 <strong style="color:#12312d;">US$10</strong>，即可取得一份<strong style="color:#12312d;">超過 60 頁</strong>的完整個人化 AI 癌症風險評估報告。報告結合 AI 模型與醫學文獻實證規則，依據您的健康史、生活型態與症狀等資訊，分析整體與各癌別風險，找出值得優先關注的癌症、重要風險因子與症狀警訊，並提供後續追蹤與健康管理方向，同時附有可供醫療專業人員快速參考的重點摘要與科學文獻依據。只需 US$10，換來一份更完整的健康風險全貌，以及更清楚的下一步。</p>
  ...
  en: {
    ...
    cta: `<div style="border:2px solid #0f766e;border-radius:16px;background:#f9fcfb;padding:26px 24px;margin-bottom:26px;">
          ...
          <div style="margin:0 0 16px;">
            <span style="display:inline-block;background:#0f766e;color:#ffffff;font-size:19px;font-weight:800;padding:7px 16px;border-radius:999px;">US$10</span>
            <span style="display:inline-block;margin-left:10px;font-size:15px;font-weight:700;color:#0f766e;line-height:2.1;">More than 60 pages</span>
          </div>
          <p style="margin:0 0 20px;font-size:15px;line-height:1.9;color:#40514f;">For just <strong style="color:#12312d;">US$10</strong>, you can access a comprehensive Personalized AI Cancer Risk Assessment Report of <strong style="color:#12312d;">more than 60 pages</strong>. By combining AI-based risk modeling with evidence from medical literature, the report evaluates your overall and cancer-specific risks based on your health history, lifestyle, and symptoms. It highlights the cancers that may deserve greater attention, identifies key personal risk factors and symptom alerts, and provides clear guidance for follow-up and health management. A concise summary for healthcare professionals and supporting scientific references are also included. For just US$10, gain a more complete picture of your health risks&mdash;and greater clarity on what to consider next.</p>
