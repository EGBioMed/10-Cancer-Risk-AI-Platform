          ...
          <script>
            (function () {
              ...
              var copy = {
                ...
                en: {
                  // Kept identical to app.js's appTitle/heroTitle: this is
                  // the page a paying customer hits first, straight from the
                  // purchase email, so it is the worst possible place for the
                  // product to introduce itself under a different name.
                  pageTitle: "AI Cancer Risk Assessment",
