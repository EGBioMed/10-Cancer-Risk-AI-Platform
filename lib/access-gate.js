...
// The denial page itself must render without a session, so its own static
// assets (stylesheet, logo) have to stay reachable even when the gate is
// enforced -- otherwise the page that explains "you're blocked" is partly
// blocked too. These are non-sensitive, no-user-data files.
